...
const string OfferNew(const string& node, const string& aliasname, const string& category, const string& title, const string& qty, const string& price, const string& description, const string& currency, const string& assetguid="''", const string& paymentoptions="SYS",  const string& offerType = "BUYNOW", const string& auction_expires = "0", const string& auction_reserve = "0", const string& auction_require_witness = "false", const string &auction_deposit = "0", const string& witness="''");
...
const string EscrowNewBuyItNow(const string& node, const string& sellernode, const string& buyeralias, const string& offerguid, const string& qtyStr, const string& arbiteralias, const string& paymentoptions = "SYS", const string& shippingFee = "0", const string& networkFee = "25", const string& arbiterFee = "0.005", const string& witnessFee = "0", const string& witness = "''");
