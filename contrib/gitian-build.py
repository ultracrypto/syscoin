...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/syscoin/gitian.sigs.git'])
    if not os.path.isdir('syscoin-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/syscoin/syscoin-detached-sigs.git'])
...
def build():
    ...
    if args.linux:
        ...
        subprocess.check_call('mv build/out/syscoincore-*.tar.gz build/out/src/syscoincore-*.tar.gz ../syscoin-binaries/'+args.version, shell=True)
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/syscoincore-*-win-unsigned.tar.gz inputs/syscoincore-win-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/syscoincore-*.zip build/out/syscoincore-*.exe ../syscoin-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/syscoincore-*-osx-unsigned.tar.gz inputs/syscoincore-osx-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/syscoincore-*.tar.gz build/out/syscoincore-*.dmg ../syscoin-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/syscoincore-*win64-setup.exe ../syscoin-binaries/'+args.version, shell=True)
        subprocess.check_call('mv build/out/syscoincore-*win32-setup.exe ../syscoin-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/syscoincore-osx-signed.dmg ../syscoin-binaries/'+args.version+'/syscoincore-'+args.version+'-osx.dmg', shell=True)
